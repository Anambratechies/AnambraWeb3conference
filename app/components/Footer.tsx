...
const Footer = () => {
  return (
    <div className="container p-16 pt-24 md:p-20 mt-10 bg-gray-100">
      <div className="flex flex-col md:flex-row justify-between items-center">
        ...
        {/* Social icons */}
        <div className="flex flex-row space-x-4 m-16 md:m-0">
          <Link href="">
            <Image
              src="/linkedin.svg"
              alt="LinkedIn logo"
      ...
      <div className="flex flex-col items-center mt-10 md:mt-28">
        <p className="text-center flex flex-col items-center md:flex-row space-y-3 md:space-y-0">
          <span className="font-semibold text-3xl md:text-xl">
            Inquiries/details
          </span>
          <span className="md:ml-2 text-lg">info@anambra-techies.com</span>
        </p>
